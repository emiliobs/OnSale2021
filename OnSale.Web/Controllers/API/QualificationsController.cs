...
namespace OnSale.Web.Controllers.API
{
    ...
    public class QualificationsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> PostQualification([FromBody] QualificationReques request)
        {
            ...
            var product = await _context.Products.Include(p => p.Qualifications).FirstOrDefaultAsync(p => p.Id == request.ProductId);
            if (product == null)
            {
